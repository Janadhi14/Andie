...
public class ViewActions {
    ...
    public ViewActions() {
        ...
        actions.add(new ZoomFullAction("Zoom-Full", null, "Zoom Full", Integer.valueOf(KeyEvent.VK_EQUALS)));
    }
    ...
    public class ZoomInAction extends ImageAction {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                JOptionPane.showMessageDialog(target, "Please open an image first.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
